...
require'lualine'.setup {
  ...
  sections = {
    ...
    lualine_c = {require('auto-session-library').current_session_name, {'filename', path = 0, symbols = {modified = ' ', readonly = ' ', unnamed = '[No Name]'}}, {gps.get_location, cond = gps.is_available}},
